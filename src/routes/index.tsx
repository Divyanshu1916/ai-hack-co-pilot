...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/Divyanshu1916", icon: <Github className="h-4 w-4" aria-hidden="true" /> },
  { label: "Discord", href: "https://discordapp.com/users/1507933325598392430", icon: (
  ...
  { label: "LinkedIn", href: "https://www.linkedin.com/in/divyanshu-kumar11", icon: <Linkedin className="h-4 w-4" aria-hidden="true" /> },
];
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 order-2 sm:order-3">
            {socialLinks.map((link) => (
              <a
                ...
                className="group flex items-center gap-1.5 px-3 py-1.5 rounded-full glass hover:bg-primary/10 hover:text-foreground transition-all duration-300 hover:scale-105 hover:shadow-[0_0_12px_color-mix(in_oklab,var(--primary)_25%,transparent)]"
              >
